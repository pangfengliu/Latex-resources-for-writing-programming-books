...
The previous code needs two files -- {\tt scan-print.in} and {\tt scan-print.out} will produce the following.
...
is a code segment that are often used in a particular situation, much
...
Note that you can refer to a phrase listing by {\tt phr:for}.
